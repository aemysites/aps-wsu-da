...
## Environments
- Preview: https://main--aps-wsu-da--aemysites.aem.page/
- Live: https://main--aps-wsu-da--aemysites.aem.live/
...
1. Open the `aps-wsu-da` directory in your favorite IDE and start coding :)
